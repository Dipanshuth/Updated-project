...
async def analyze_evidence(evidence_id: str):
    ...
    try:
        ...
        if confidence >= 0.75:
            keywords = ["extreme_energy", "distress", "urgent", "elevated_pitch", "rapid_speech"]
        elif confidence >= 0.55:
            keywords = ["elevated_energy", "stress", "raised_voice", "tension"]
        elif confidence >= 0.35:
            keywords = ["moderate_energy", "slight_stress", "elevated_tone"]
        else:
            keywords = ["normal_speech", "calm", "conversational"]
